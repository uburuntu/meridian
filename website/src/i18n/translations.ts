...
export const translations: Record<string, Record<string, string>> = {
  ru: {
    ...
    'builder.field.ip.hint': 'Публичный IPv4 вашего VPS. Оставьте пустым для интерактивного режима.',
  ...
  fa: {
    ...
    'builder.field.ip.hint': 'آدرس IPv4 عمومی VPS. برای حالت تعاملی خالی بگذارید.',
  ...
  zh: {
    ...
    'builder.field.ip.hint': 'VPS 的公共 IPv4 地址。留空使用交互模式。',
